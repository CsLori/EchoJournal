package com.cslori.echojournal.echos.data.settings
...
class DataSoreSettings(private val context: Context) : SettingsPreferences {
    ...
    override suspend fun saveDefaultTopics(topics: List<String>) {
        context.settingsDataStore.edit { prefs ->
            prefs[topicsKey] = topics.toSet().joinToString()
        }
    }
